...
//question page and go to next question if the answer is correct
//automatically retake the question if the answer is wrong
function handlesSubmitAnswer(){
    ...
    $('.quiz-page').on("submit", "form",function(event){
        ...
        //if the answer is correct go to next question
